  #include <iostream>
      ...
      int main()
      {
        ...
        int cases,p,i;
        cin>>cases;
        unsigned int m[100],n[100],t[100];
        unsigned int M,N,T;
        unsigned int HPSET[100][5];
        unsigned int ATKSET[100][5];
        for(p=0;p<cases;p++)
        {
            cin >> m[p] >> n[p] >> t[p];   
