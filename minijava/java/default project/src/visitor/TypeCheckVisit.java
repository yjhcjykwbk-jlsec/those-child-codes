...
public class TypeCheckVisit extends GJDepthFirst<TypeItem,Object>{	
    ...
    */ 
    ...
    public TypeItem visit(MethodDeclaration n, Object argu) {
       ...
       else if(!left.equalWith(temp))
       {
    	   func.returnType=left;
       }
       return null;
    }
    ...
    */
    ...
    public TypeItem visit(MessageSend n, Object argu) {
       ...
       //System.out.println("000000000000000000"+n.className);
    ...
    public TypeItem visit(ExpressionList n, Object argu) {
       ...
       {
    	   n.f1.accept(this, argu);
    	   index=indexstack.elementAt(0);
    	   if(size>index) 
           {
        	   System.out.println("TypeError: in function "+funcstack.elementAt(0).name +" para number should be "+size+" not "+(index+1));   
           }
       }
       else
    	{
