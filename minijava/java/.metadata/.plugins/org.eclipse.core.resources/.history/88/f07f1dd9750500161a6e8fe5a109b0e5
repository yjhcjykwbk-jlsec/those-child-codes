...
public class TypeCheckVisit extends GJDepthFirst{	
    ...
    public void isEqual(TypeItem a,TypeItem b)throws WrongTypeException
    {
    	if(!a.equals(b)) throw (new WrongTypeException());
    }
    /**
     * f0 -> MainClass()
     * f1 -> ( TypeDeclaration() )*
    ...
    public TypeItem visit(MainClass n, Object argu) {
       ...
       //System.out.println("checking class "+table.name+"...");
    ...
    */ 
    ...
    public TypeItem visit(MethodDeclaration n, Object argu) {
       ...
       if(!left.equals(func.returnType))
       {
